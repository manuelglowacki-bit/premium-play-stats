    ...
    <AppShell>
      <div className="mx-auto max-w-7xl space-y-6 pb-32 p-4 md:p-6 text-slate-100 font-sans">
        ...
        <section className="grid grid-cols-1 gap-6">
          <div className="rounded-[26px] border border-white/10 bg-[#07101d] p-6 shadow-xl md:p-7">
            <div className="border-b border-white/10 pb-5">
              <span className="text-[10px] font-mono font-bold uppercase tracking-[.22em] text-cyan-300">Identité</span>
              <h2 className="mt-1 font-display text-xl font-black uppercase text-white">Mon pseudo</h2>
            </div>

            <form onSubmit={handleUpdateProfile} className="mt-6 space-y-5">
              <div>
                <label className="mb-2 block text-[10px] font-mono font-bold uppercase tracking-wider text-slate-500">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-[#040a14] p-4 text-sm text-white outline-none transition focus:border-cyan-400/50"
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-[#ccff00] px-7 py-3.5 font-display text-xs font-black uppercase tracking-wider text-slate-950 shadow-lg shadow-[#ccff00]/10 transition hover:bg-[#b8eb00]"
                >
                  {savedProfile ? <Check className="mr-1 inline size-4" /> : null}
